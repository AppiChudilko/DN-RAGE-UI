      ...
      car_list: [
        {
          ...
          character_car: [
            { title: 'Скорость', info: '125 км/ч' },
            { title: 'Длина', info: '250 м' },
            { title: 'Ширина', info: '100 м' },
          ],
          color_car_main: ['1', '2', '3', '4', '5', '6', '7'],
          color_car_secondary: ['11', '22', '33', '44', '55', '66', '77'],
          current_main_color: '7',
          current_secondary_color: '7',
        ...
        },
        {
          ...
          img: 'https://i.yapx.ru/GakPT.png',
          character_car: [
            { title: 'Скорость', info: '325 км/ч' },
            { title: 'Длина', info: '150 м' },
            { title: 'Ширина', info: '2100 м' },
          ],
          color_car_main: ['13', '23', '33', '43', '53', '63', '73', '24', '34', '44', '54', '64', '74', '24', '34', '44', '54', '64', '74'],
          color_car_secondary: ['1', '2', '3', '4', '5', '6', '7'],
          current_main_color: '13',
          current_secondary_color: '1',
      ...
      <React.Fragment >
        <div className="carshop-position" id="box">
            ...
            {this.state.change_car !== "" ?
              <React.Fragment>
                <div className="clr-m-btn-box">
                  <input type="radio" name="colorcarslider" id="ccslider1" defaultChecked onClick={() => this.currentColorBtn('main')} />
                  <label htmlFor="ccslider1" className="ccslider-box">Основной</label>
                  <input type="radio" name="colorcarslider" id="ccslider2" onClick={() => this.currentColorBtn('secondary')} />
                  <label htmlFor="ccslider2" className="ccslider-box">Дополнительный</label>
                </div>
                <div className="color-box-slider" key={`${this.state.current_btn_color} ${this.state.change_car.make} ${this.state.change_car.model}`}>
                  <Slider
                    draggable={false}
                    dots={false}
                    ...
                    afterChange={this.state.current_btn_color === 'main' ?
                      (current, next) => this.setState(prev => ({ ...prev.change_car.current_main_color = this.state.change_car.color_car_main[current] }))
                      :
                      (current, next) => this.setState(prev => ({ ...prev.change_car.current_secondary_color = this.state.change_car.color_car_secondary[current] }))
                    }
                  ...
                  >
                    {this.state.current_btn_color === 'main' ?
                      this.state.change_car.color_car_main.map((e, i) => {
                        ...
                        return (
                          <div key={index}>
                            <div className="clr-list-box" style={{ backgroundColor: this.state.car_colors[e].color }}></div>
                          </div>
                        )
                      })
                      :
          ...
          <div className="info-menu-right-position">
            {this.state.change_car !== "" ?
              <React.Fragment>
                <div className="inf-t-menu-r">{this.state.change_car.make} {this.state.change_car.model}</div>
