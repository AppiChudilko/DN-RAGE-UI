...
class EditorPlayer extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      stats_parents: [[ //22
        ...
        { endurance: 15, strength: 25, shooting: 50, stealth: 15, flying: 10, driving: 40, psychics: 55 },
        { endurance: 5, strength: 25, shooting: 10, stealth: 20, flying: 50, driving: 5, psychics: 15 },
        { endurance: 50, strength: 10, shooting: 15, stealth: 25, flying: 45, driving: 20, psychics: 65 },
        { endurance: 25, strength: 30, shooting: 35, stealth: 5, flying: 20, driving: 30, psychics: 45 },
        { endurance: 30, strength: 40, shooting: 35, stealth: 50, flying: 15, driving: 25, psychics: 95 },
        { endurance: 30, strength: 50, shooting: 35, stealth: 5, flying: 25, driving: 30, psychics: 75 },
        { endurance: 45, strength: 10, shooting: 20, stealth: 30, flying: 40, driving: 15, psychics: 60 },
        ...
        { endurance: 35, strength: 35, shooting: 25, stealth: 40, flying: 30, driving: 25, psychics: 90 },
        { endurance: 20, strength: 40, shooting: 45, stealth: 5, flying: 15, driving: 10, psychics: 35 },
        { endurance: 25, strength: 45, shooting: 5, stealth: 50, flying: 20, driving: 35, psychics: 80 },
        { endurance: 10, strength: 20, shooting: 5, stealth: 20, flying: 5, driving: 50, psychics: 10 },
        { endurance: 40, strength: 5, shooting: 30, stealth: 40, flying: 30, driving: 25, psychics: 70 },
        { endurance: 10, strength: 10, shooting: 20, stealth: 35, flying: 35, driving: 20, psychics: 30 },
        { endurance: 40, strength: 30, shooting: 25, stealth: 35, flying: 35, driving: 20, psychics: 85 },
        ...
        { endurance: 50, strength: 20, shooting: 15, stealth: 25, flying: 45, driving: 10, psychics: 65 },
        ...
        { endurance: 5, strength: 25, shooting: 10, stealth: 35, flying: 50, driving: 5, psychics: 30 },
        { endurance: 20, strength: 50, shooting: 25, stealth: 25, flying: 30, driving: 40, psychics: 90 },
        { endurance: 50, strength: 20, shooting: 15, stealth: 25, flying: 45, driving: 10, psychics: 65 },
      ]],
  ...
  valuePromocode(event) { this.setState({ promocode: event.target.value.replace(/[^a-zA-Z0-9]+/g,'') }) };
  valueReferer(event) { this.setState({ referer: event.target.value.replace(/[^a-zA-Z\s]+/g,'') }) };
  resetNameCharacter() {
    this.setState(prev => ({
