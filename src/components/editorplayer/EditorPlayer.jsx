  ...
  constructor(props) {
    ...
    this.state = {
      ...
      input_editor_face_last: [
        { title: "Волосы", maxVal: 10, index_help: 0 },
        { title: "Цвет волос", maxVal: 10, index_help: 0 },
        { title: "Брови", maxVal: 10, index_help: 0 },
        { title: "Цвет бровей", maxVal: 10, index_help: 0 },
        { title: "Цвет глаз", maxVal: 10, index_help: 0 },
      ...
      cheked_sex: false,
      slider: [
        { title: "Мать", parents: ["Lesya", "Masha", "Kristina"], index_help: 0 },
        { title: "Отец", parents: ["Kirill", "Andrey", "Vasya"], index_help: 0 },
