        ...
        <div className="сamera-editor-main">
          <div className="range-editor-block">
            ...
            <div className="range-slider-editor">
              <InputRange
                ...
                onChange={value => {this.setState({ value }); this.changeCam()}}
          ...
          <div className="range-editor-block">
            ...
            <InputRange
                ...
                onChange={value2 => {this.setState({ value2 }); this.changeCam()}}
          ...
          <div className="range-editor-block">
            ...
            <InputRange
                ...
                onChange={value3 => {this.setState({ value3 }); this.changeCam()}}
