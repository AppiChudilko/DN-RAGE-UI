      ...
      <React.Fragment>
        <div className="menu-editor-default">
          ...
          <div className="change-sex-block">
            <input type="radio" name="change-sex" id="change-male" defaultChecked onChange={this.props.chekedSex.bind(this)} />
            <label htmlFor="change-male" className="change-sex-style">Мужской</label>
            <input type="radio" name="change-sex" id="change-female" onChange={this.props.chekedSex.bind(this)} />
          ...
          <div className="characteristic-editor">
            <div className="box-character">
              ...
              <div className="range-character">
                <div className="background-character-range" style={{ width: this.props.endurance + "%" }} ></div>
              </div>
            </div>
            <div className="box-character">
              <span className="title-character">Сила</span>
              <div className="range-character">
                <div className="background-character-range" style={{ width: this.props.strength + "%" }}></div>
              </div>
            </div>
            <div className="box-character">
