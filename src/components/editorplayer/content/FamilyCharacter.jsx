      ...
      <React.Fragment>
        <div className="menu-editor-default">
          ...
          <div className="change-sex-block">
            <input type="radio" name="change-sex" id="change-male" defaultChecked onChange={this.chekedSex.bind(this)}/>
            <label htmlFor="change-male" className="change-sex-style">Мужской</label>
            <input type="radio" name="change-sex" id="change-female" onChange={this.chekedSex.bind(this)}/>
