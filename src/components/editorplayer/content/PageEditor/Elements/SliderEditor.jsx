      ...
      <React.Fragment>
          <div className="box-change otstup-box">
            ...
            <div className="box-in-change editor-box-style">
              ...
              <div className="label-change color-white">{this.props.name_array[this.props.index_help] !== undefined ? this.props.name_array[this.props.index_help] : this.props.name_array}</div>
