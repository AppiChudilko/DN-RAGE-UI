    ...
    return (
      <React.Fragment >
        <div className="logo-main">
          ...
          <div style={{backgroundColor: 'rgba(0, 0, 0, ' + this.state.background + ')'}} className={this.state.showAmmo ? 'logo-ammo' : 'hide'}>
            <div className={'logo-ammo-img ammo-' + this.state.ammoMode}></div> {this.state.ammoCount}
          </div>
        </div>
      </React.Fragment>
    )
